...
import de.nulldrei.oop.ex4.business.baelle.Ball;
import de.nulldrei.oop.ex4.ownUtil.MeldungsfensterAnzeiger;
import de.nulldrei.oop.ex4.ownUtil.Observable;
import de.nulldrei.oop.ex4.ownUtil.Observer;
import javafx.event.*;
   ...
   private void initListener() {
	    ...
	    mnItmCsvImport.setOnAction(new EventHandler<ActionEvent>() {
	        ...
	        public void handle(ActionEvent e) {
				...
				// Wir geben den Observern bescheid
				notifyObservers();
	        } 
        });
   }
